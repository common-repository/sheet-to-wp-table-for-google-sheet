...
abstract class Base{
    ...
    public $plugin_prefix = STWT_PREFIX;
    public $dev_version = STWT_DEV_VERSION;
    public $plugin_name = STWT_PLUGIN_NAME;
    public $base_url = STWT_BASE_URL;
    public $base_dir = STWT_BASE_DIR;
    public $assets_url = STWT_ASSETS_URL;
